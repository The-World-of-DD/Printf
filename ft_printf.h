...
/*   Updated: 2025/03/28 00:43:42 by dierojas         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	ft_pointer_aux(char const *s, va_list args);
int	ft_putchar_aux(char const *s, va_list args);
int	ft_putnbr_aux(char const *s, va_list args);
int	ft_putstr_aux(char const *s, va_list args);
